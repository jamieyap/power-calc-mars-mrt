...
* **Decision Point:** Each day of the 10-day Micro-Randomized Trial (MRT) is divided into six consecutive non-overlapping blocks of time; each block is approximately 2 hours and 20 minutes long. For the purpose of calculating power, we assume that micro-randomization occurs at the beginning of each block. Further, we assume that the end of the sixth block of the current day will be followed immediately (i.e., no time gap) by the first block of the next day. Together, these assumptions imply that the decision points, which we index by $t = 1, 2, 3, ..., 60$, will be spaced approximately 2 hours and 20 minutes apart.
...
In Figure 1, we illustrate the MRT data for the  $1^{st}, 2^{nd}, 3^{rd}, ..., 60^{th}$ decision points.
